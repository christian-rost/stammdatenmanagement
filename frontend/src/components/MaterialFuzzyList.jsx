    ...
    <div className="tree-view">
      ...
      <div className="tree-view-list">
        ...
        {!loading && filtered.map(pair => {
          const key = `${pair.matnr_a}||${pair.matnr_b}`
          const isSelected = selected && `${selected.matnr_a}||${selected.matnr_b}` === key
          return (
            <div
              key={key}
            ...
            >
              <div className="tree-item-info">
                <div className="tree-item-name" title={pair.maktx_a}>{pair.maktx_a}</div>
                <div className="tree-item-ort fuzzy-vs">
                  <span className="vs-label">vs</span>
                  <span style={{ color: 'var(--color-text)' }} title={pair.maktx_b}>{pair.maktx_b}</span>
                </div>
              </div>
...
export default MaterialFuzzyList
